...
echo 'deb [arch=amd64, signed-by=/usr/share/keyrings/tpokorra-keyring.gpg] https://download.solidcharity.com/repos/tpokorra/nant/debian/buster buster main' | tee  /etc/apt/sources.list.d/tpokorra-nant.list
apt-get update
