...
#echo 'deb [arch=amd64, signed-by=/usr/share/keyrings/solidcharity-openpetra.gpg] https://download.solidcharity.com/repos/tpokorra/mono/debian/bullseye bullseye main' > /etc/apt/sources.list.d/mono-tpokorra.list
echo 'deb [arch=amd64, signed-by=/usr/share/keyrings/solidcharity-openpetra.gpg] https://download.solidcharity.com/repos/tpokorra/nant/debian/bullseye bullseye main' > /etc/apt/sources.list.d/tpokorra-nant.list
apt-get update
